...
class SingleTableInheritanceScope implements Scope {
    ...
    public function remove(Builder $builder, Model $model) {
        ...
        foreach ($query->wheres as $key => $where) {
            ...
            // the query and reset the keys on the wheres. This allows the developer to
            ...
            if ($this->isSingleTableInheritanceConstraint($where, $column)) {
                ...
                // Assume (naively) that no other scope is binding the same values as the values of our input query.
                // Not perfect but its about the best we can do without the query keeping better track of which bindings
     ...
     * @return bool
     */
    protected function isSingleTableInheritanceConstraint(array $where, string $column): bool
    {
